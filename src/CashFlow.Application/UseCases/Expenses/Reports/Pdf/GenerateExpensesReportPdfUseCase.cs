...
public class GenerateExpensesReportPdfUseCase : IGenerateExpensesReportPdfUseCase
{
    ...
    public async Task<byte[]> Execute(DateOnly month)
    {
        ...
        CreateHeaderWithProfileFoto(page);
    ...
    private Document CreateDocument(DateOnly month)
    {
        ...
        document.Info.Author = "Rui Costa";
    ...
    private void CreateHeaderWithProfileFoto(Section page)
    {
        ...
        var pathFile = Path.Combine(directoryName!, "Logo", "james_hetfield.png");

        row.Cells[0].AddImage(pathFile);

        row.Cells[1].AddParagraph("Hey, James");
